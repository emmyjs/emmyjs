...
function Home () {
  ...
  return /*html*/`
    ...
    <a href="/" onclick="route(event)" class="inline-flex items-center justify-center p-5 text-base font-medium rounded-lg text-gray-400 bg-gray-800 hover:bg-gray-700 hover:text-white">
