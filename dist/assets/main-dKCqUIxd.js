...
<Route href='/documentation/vite' to='Vite'></Route>`});function sn({el:n}){return n.className="flex flex-col justify-between items-center text-center w-full gap-6",_`
  ...
  `}N(sn,"About");document.querySelectorAll("emmy-about").forEach(n=>{n.connectedCallback()});function ln({el:n}){return n.className="flex flex-col justify-space-between gap-2 text-center w-full h-full box-border",_`
    <Header />
    <Route href='/' to='Home' />
